        ...
        <div class="register-container">
            ...
            <form @submit.prevent="handleRegister" class="floating-form">
              ...
              <div class="input-group">
                ...
                <div class="option">
                    <input type="radio" id="enterprise" name="category" value="enterprise" v-model="category" />
                    <label for="enterprise">企业</label>
                </div>
                <div class="option">
                    <input type="radio" id="personal" name="category" value="personal" v-model="category" />
                    <label for="personal">个人</label>
                </div>
                <div class="option">
                    <input type="radio" id="bank" name="category" value="bank" v-model="category" />
